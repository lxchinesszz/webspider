...
public class SpiderThreadPoolExecutor {
    ...
    public SpiderThreadPoolExecutor(ThreadFactory threadFactory) {
        this(threadFactory,4,8);
    }

    public SpiderThreadPoolExecutor(ThreadFactory threadFactory,int corePoolsize,int maximumPoolSize) {
    ...
    public Executor getExecutory() {
        return new ThreadPoolExecutor(corePoolSize, maximumPoolSize, keepAliveTime,
                ...
                , threadFactory, new SpiderRejectedExecutionHandler());
    }
}
